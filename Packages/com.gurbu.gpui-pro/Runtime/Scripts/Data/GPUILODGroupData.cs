...
namespace GPUInstancerPro
{
    ...
    public class GPUILODGroupData : ScriptableObject, IGPUIParameterBufferData, IGPUIDisposable
    {
        ...
        public GPUIRendererData AddRenderer(int lodIndex, Mesh mesh, Material[] materials, Matrix4x4 transformOffset, int layer, ShadowCastingMode shadowCastingMode, bool receiveShadows = true, MotionVectorGenerationMode motionVectorGenerationMode = MotionVectorGenerationMode.Camera, bool isSkinnedMesh = false, bool doesNotContributeToBounds = false, uint renderingLayerMask = 1, LightProbeUsage lightProbeUsage = LightProbeUsage.Off, int forceMeshLod = -1)
        {
            ...
            GPUIRendererData renderer = new GPUIRendererData(mesh, materials, transformOffset, layer, shadowCastingMode, receiveShadows, motionVectorGenerationMode, isSkinnedMesh, doesNotContributeToBounds, renderingLayerMask, lightProbeUsage, forceMeshLod);
