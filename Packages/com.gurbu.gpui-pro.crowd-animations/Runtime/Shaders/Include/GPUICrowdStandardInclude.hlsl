...
VertexOutputForwardBase vertForwardBaseGPUI(appdata_full v, uint vid : SV_VertexID)
{
    UNITY_SETUP_INSTANCE_ID(v);
    GPUI_CROWD_VERTEX(vid, v.vertex.xyz, v.normal.xyz, v.tangent.xyz);
...
VertexOutputForwardAdd vertForwardAddGPUI(appdata_full v, uint vid : SV_VertexID)
{
    UNITY_SETUP_INSTANCE_ID(v);
    GPUI_CROWD_VERTEX(vid, v.vertex.xyz, v.normal.xyz, v.tangent.xyz);
...
VertexOutputBaseSimple vertForwardBaseSimpleGPUI (appdata_full v, uint vid : SV_VertexID)
{
    UNITY_SETUP_INSTANCE_ID(v);
    GPUI_CROWD_VERTEX(vid, v.vertex.xyz, v.normal.xyz, v.tangent.xyz);
...
VertexOutputForwardAddSimple vertForwardAddSimpleGPUI (appdata_full v, uint vid : SV_VertexID)
{
...
#else
VertexOutputForwardBase vertBaseGPUI(appdata_full v, uint vid : SV_VertexID)
{
    return vertForwardBaseGPUI(v, vid);
}
VertexOutputForwardAdd vertAddGPUI(appdata_full v, uint vid : SV_VertexID)
{
    return vertForwardAddGPUI(v, vid);
}
...
struct VertexOutputDeferredGPUI
{
    ...
    VertexOutputDeferredGPUI vertDeferredGPUI(appdata_full v, uint vid : SV_VertexID)
    {
        UNITY_SETUP_INSTANCE_ID(v);
        GPUI_CROWD_VERTEX(vid, v.vertex.xyz, v.normal.xyz, v.tangent.xyz);
