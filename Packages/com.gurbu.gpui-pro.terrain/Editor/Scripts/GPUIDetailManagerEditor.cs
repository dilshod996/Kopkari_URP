...
namespace GPUInstancerPro.TerrainModule
{
    ...
    public class GPUIDetailManagerEditor : GPUITerrainManagerEditor<GPUIDetailPrototypeData>
    {
        ...
        protected override void DrawManagerSettings()
        {
            ...
            detailManagerSettingsVE.Add(DrawSerializedProperty(serializedObject.FindProperty("isCheckTerrainBounds")));
        ...
        protected override void DrawManagerAdvancedSettings()
        {
            ...
            bool advancedSettingsModified = disableAsyncDetailDataRequestSP.boolValue || waitForAsyncDetailDataRequestCompletionSP.boolValue;
