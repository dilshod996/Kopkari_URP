...
namespace Michsky.UI.ModernUIPack
{
    ...
    public class NotificationManager : MonoBehaviour
    {
        ...
        public void CustomeUpdate(string title, string description, bool isRed=false)
        {
            try
            {
                //iconObj.sprite = icon;
                ...
                if(isRed == true)
                {
                    descriptionObj.color = Color.red;
                }
                else
                {
                    descriptionObj.color = new Color32(28, 13, 3, 255); 
                }
                descriptionObj.text = description;
            }
        ...
        public void CustomBoboy(string description)
        {
            try
            {
                descriptionObj.text = description;
