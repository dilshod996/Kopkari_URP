Shader "Unreal/GermanShepherd_Material"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "07. Normal", 2D ) = "white" {}
		Material_Texture2D_1( "01. Albedo", 2D ) = "white" {}
		Material_Texture2D_2( "04. Roughness", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.200000,1.200000,1.200000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(1.200000,1.200000,1.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[6] = float4(0.500000,0.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.000015,0.000000,-34616126911055216827695104.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.000015,0.000000,-34616126911055216827695104.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.000015,0.000000,-34616126911055216827695104.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(-34616126911055216827695104.000000,0.000000,-2486655497378201600.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local5 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[3].xyz,Material.PreshaderBuffer[2].w);
	MaterialFloat Local6 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 2);
	MaterialFloat4 Local7 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local8 = MaterialStoreTexSample(Parameters, Local7, 2);
	MaterialFloat3 Local9 = PositiveClampedPow(Local7.rgb,((MaterialFloat3)Material.PreshaderBuffer[3].w));
	MaterialFloat3 Local10 = (Local9 * Material.PreshaderBuffer[5].xyz);
	MaterialFloat Local11 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local12 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local13 = MaterialStoreTexSample(Parameters, Local12, 0);
	MaterialFloat3 Local14 = (Local12.rgb + ((MaterialFloat3)Material.PreshaderBuffer[6].y));
	MaterialFloat3 Local15 = saturate(Local14);
	MaterialFloat3 Local16 = PositiveClampedPow(Local15,((MaterialFloat3)Material.PreshaderBuffer[6].z));
