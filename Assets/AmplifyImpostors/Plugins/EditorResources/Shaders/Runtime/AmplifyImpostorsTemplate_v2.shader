	...
	SubShader
	{
		...
		*/
		...
		Pass
		{
			...
			Tags
			{
				/*ase_immutable*/ "LightMode" = "ForwardAdd"
			}
			ZWrite Off
			Blend One One
		...
		Pass
		{
			...
			Tags
			{
				/*ase_immutable*/ "LightMode" = "Deferred"
			}
		...
		Pass
		{
			...
			Pass
			{
				...
				Tags
				{
					/*ase_immutable*/ "LightMode" = "ShadowCaster"
				}
				ZWrite On
				ZTest LEqual
				AlphaToMask Off
		...
		Pass
		{
			...
			Tags
			{
				/*ase_immutable*/ "LightMode" = "SceneSelectionPass"
			}
