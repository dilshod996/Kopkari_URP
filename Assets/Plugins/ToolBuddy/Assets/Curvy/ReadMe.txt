...
8.11.1
	[CHANGED] All materials now use shaders created with Shader Graph. This eliminates the material conversion step when using SRP or HDRP.
	[FIXED] Rare "Undo object may not be null" message when exiting Play mode.
	[FIXED] Minor aesthetic issues in scene 50.
