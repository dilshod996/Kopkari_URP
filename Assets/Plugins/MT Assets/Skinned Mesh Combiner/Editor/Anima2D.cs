...
namespace MTAssets.SkinnedMeshCombiner.Editor
{
    ...
    class Anima2D
    {
        ...
        public static void DetectIfAnima2dAssetExists()
        {
            ...
            if (AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/Skinned Mesh Combiner/Editor/DetectorAnima2D.cs", typeof(object)) != null)
            {
                AssetDatabase.DeleteAsset("Assets/Plugins/MT Assets/Skinned Mesh Combiner/Editor/DetectorAnima2D.cs");
                AssetDatabase.Refresh();
            }

            //Delete the old script of rendering, if exists
            if (AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/Skinned Mesh Combiner/Scripts/RendererOfCombinedAnima2D.cs", typeof(object)) != null)
            {
                AssetDatabase.DeleteAsset("Assets/Plugins/MT Assets/Skinned Mesh Combiner/Scripts/RendererOfCombinedAnima2D.cs");
                AssetDatabase.Refresh();
            }
        }
