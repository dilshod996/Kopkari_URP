    ...
    public class SpriteMeshesLayersOrdener : EditorWindow
    {
        ...
        */
        ...
        static void LoadThePreferences(SpriteMeshesLayersOrdener instance)
        {
            ...
            layersOrdenerPreferences = (SmLayersOrdenerPreferences)AssetDatabase.LoadAssetAtPath("Assets/Plugins/MT Assets/_AssetsData/Preferences/SpriteMeshesLayersOrdener.asset", typeof(SmLayersOrdenerPreferences));
            ...
            if (layersOrdenerPreferences != null)
            {
                ...
                {
                    AssetDatabase.DeleteAsset("Assets/Plugins/MT Assets/_AssetsData/Preferences/SpriteMeshesLayersOrdener.asset");
            ...
            if (layersOrdenerPreferences == null)
            {
                ...
                AssetDatabase.CreateAsset(layersOrdenerPreferences, "Assets/Plugins/MT Assets/_AssetsData/Preferences/SpriteMeshesLayersOrdener.asset");
                AssetDatabase.SaveAssets();
                AssetDatabase.Refresh();
            }
        }
