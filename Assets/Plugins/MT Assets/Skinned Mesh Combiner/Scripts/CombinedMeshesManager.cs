    ...
    public class CombinedMeshesManager : MonoBehaviour
    {
        ...
        public class CustomInspector : UnityEditor.Editor
        {
            public override void OnInspectorGUI()
            {
                ...
                {
                    script.GetComponent<SkinnedMeshRenderer>().sharedMesh.uv2 = script.GetComponent<SkinnedMeshRenderer>().sharedMesh.uv;
#if UNITY_EDITOR
                    EditorUtility.SetDirty(script.GetComponent<SkinnedMeshRenderer>().sharedMesh);
#endif
                    Debug.Log("The Primary UV of mesh \"" + script.GetComponent<SkinnedMeshRenderer>().sharedMesh.name + "\" was copied to UV2 successfully!");
                }

                if (GUILayout.Button("Copy Primary UV to UV3", GUILayout.Height(25)))
                {
                    script.GetComponent<SkinnedMeshRenderer>().sharedMesh.uv3 = script.GetComponent<SkinnedMeshRenderer>().sharedMesh.uv;
#if UNITY_EDITOR
                    EditorUtility.SetDirty(script.GetComponent<SkinnedMeshRenderer>().sharedMesh);
#endif
                    Debug.Log("The Primary UV of mesh \"" + script.GetComponent<SkinnedMeshRenderer>().sharedMesh.name + "\" was copied to UV3 successfully!");
                }

                if (GUILayout.Button("Copy Primary UV to UV4", GUILayout.Height(25)))
                {
                    script.GetComponent<SkinnedMeshRenderer>().sharedMesh.uv4 = script.GetComponent<SkinnedMeshRenderer>().sharedMesh.uv;
#if UNITY_EDITOR
                    EditorUtility.SetDirty(script.GetComponent<SkinnedMeshRenderer>().sharedMesh);
#endif
                    Debug.Log("The Primary UV of mesh \"" + script.GetComponent<SkinnedMeshRenderer>().sharedMesh.name + "\" was copied to UV4 successfully!");
                }

                if (GUILayout.Button("Copy Primary UV to UV5", GUILayout.Height(25)))
                {
                    script.GetComponent<SkinnedMeshRenderer>().sharedMesh.uv5 = script.GetComponent<SkinnedMeshRenderer>().sharedMesh.uv;
#if UNITY_EDITOR
                    EditorUtility.SetDirty(script.GetComponent<SkinnedMeshRenderer>().sharedMesh);
#endif
                    Debug.Log("The Primary UV of mesh \"" + script.GetComponent<SkinnedMeshRenderer>().sharedMesh.name + "\" was copied to UV5 successfully!");
                }

                if (GUILayout.Button("Copy Primary UV to UV6", GUILayout.Height(25)))
                {
                    script.GetComponent<SkinnedMeshRenderer>().sharedMesh.uv6 = script.GetComponent<SkinnedMeshRenderer>().sharedMesh.uv;
#if UNITY_EDITOR
                    EditorUtility.SetDirty(script.GetComponent<SkinnedMeshRenderer>().sharedMesh);
#endif
                    Debug.Log("The Primary UV of mesh \"" + script.GetComponent<SkinnedMeshRenderer>().sharedMesh.name + "\" was copied to UV6 successfully!");
                }

                if (GUILayout.Button("Copy Primary UV to UV7", GUILayout.Height(25)))
                {
                    script.GetComponent<SkinnedMeshRenderer>().sharedMesh.uv7 = script.GetComponent<SkinnedMeshRenderer>().sharedMesh.uv;
#if UNITY_EDITOR
                    EditorUtility.SetDirty(script.GetComponent<SkinnedMeshRenderer>().sharedMesh);
#endif
                    Debug.Log("The Primary UV of mesh \"" + script.GetComponent<SkinnedMeshRenderer>().sharedMesh.name + "\" was copied to UV7 successfully!");
                }
            }
        }
        #endregion
            ...
            for (int i = 0; i < thisMeshRenderer.sharedMesh.subMeshCount; i++)
            {
                ...
                if (rootCombiner != null && Application.isPlaying == false)
                    if (rootCombiner.saveDataInAssets == true)
                    {
                        ...
                        if (!AssetDatabase.IsValidFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes/Splited"))
                            AssetDatabase.CreateFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes", "Splited");

                        //Save the mesh into asset files
                        string meshDir = "Assets/Plugins/MT Assets/_AssetsData/Meshes/Splited/" + thisMeshRenderer.sharedMesh.name + " Split " + i.ToString() + ".asset";
