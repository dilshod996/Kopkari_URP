    ...
    public class SkinnedMeshConverter : MonoBehaviour
    {
        ...
        private void DoConvertMesh()
        {
            ...
            if (Application.isPlaying == false && saveDataInAssets == true)
            {
                ...
                if (!AssetDatabase.IsValidFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes/ConvertedToSkinned"))
                    AssetDatabase.CreateFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes", "ConvertedToSkinned");
                ...
                //Save the asset
                string fileDirectory = "Assets/Plugins/MT Assets/_AssetsData/Meshes/ConvertedToSkinned/" + originalMesh.name + " (" + dateNowStr + ").asset";
