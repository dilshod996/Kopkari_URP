Shader "GPUInstancerPro/Variation/Chomper_CrowdAnimations/Universal Render Pipeline/Lit"
{
    Properties
    {
...
#define UNIVERSAL_DOTS_PRAGMAS_INCLUDED // Added by GPUIPro
            ...
            // -------------------------------------
            // Shader Stages
            #pragma vertex LitPassVertexGPUICA
...
Varyings LitPassVertexGPUICA(Attributes input, uint vertexID : SV_VertexID)
{
    #ifdef GPUI_PRO_CROWD_ACTIVE
...
#include_with_pragmas "./Chomper_MatVariation_GPUIVariationInclude.hlsl"
...
#define UNIVERSAL_DOTS_PRAGMAS_INCLUDED // Added by GPUIPro
            ...
            // -------------------------------------
            // Shader Stages
            #pragma vertex LitGBufferPassVertexGPUICA
...
Varyings LitGBufferPassVertexGPUICA(Attributes input, uint vertexID : SV_VertexID)
{
    #ifdef GPUI_PRO_CROWD_ACTIVE
        UnitySetupInstanceID(UNITY_GET_INSTANCE_ID(input));
        setupGPUI();
