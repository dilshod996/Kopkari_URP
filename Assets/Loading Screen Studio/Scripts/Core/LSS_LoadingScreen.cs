...
namespace Michsky.LSS
{
    ...
    public class LSS_LoadingScreen : MonoBehaviour
    {
        ...
        void ProcessLoading()
        {
            ...
            else if (customSceneActivation 
                && loadingProcess.progress == 0.9f 
                && isContentFadeInCompleted
                && !isContentFadeOutRunning
                && !isContentFadeOutCompleted)
            {
            ...
            else if (!enablePressAnyKey
                && loadingProcess.isDone
