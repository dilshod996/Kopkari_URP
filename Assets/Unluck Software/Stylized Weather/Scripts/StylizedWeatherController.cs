...
namespace UnluckSoftware
{
	...
	public class StylizedWeatherController :MonoBehaviour
	{
		...
		[Tooltip("If no Follow Object is assigned, the controller will follow Camera.main.")]
		public bool autoFollowMainCamera = true;
		...
		{
			if (!followObject && autoFollowMainCamera && Camera.main)
