...
public class UserDetails : MonoBehaviour
{
    ...
    void Start()
    {
        string currentUsername = PlayerPrefs.GetString(UsernameKey);
    ...
    private void SaveUsername()
    {
        ...
        if (!string.IsNullOrEmpty(newUsername))
        {
            ...
            PlayerPrefs.SetInt(CountryName, countryDropdown.selectedItemIndex);
            PlayerPrefs.Save();
    ...
    {
        int selectedCountry = PlayerPrefs.GetInt(CountryName);
