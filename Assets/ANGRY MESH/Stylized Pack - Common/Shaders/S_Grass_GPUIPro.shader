...
Shader "GPUInstancerPro/ANGRYMESH/Stylized Pack/Grass"
{
	Properties
	{
...
#pragma multi_compile_instancing
						 ...
						 ) : SV_Target
			{
				...
				half staticSwitch726 = lerpResult304;
				#else
				half staticSwitch726 = _BaseSmoothnessIntensity;
				#endif
				half Base_Smoothness314 = saturate( staticSwitch726 );
				...
				half dither735 = Dither4x4Bayer( fmod( ase_positionSS_Pixel.x, 4 ), fmod( ase_positionSS_Pixel.y, 4 ) );
				...
				half staticSwitch738 = ( dither735 * Base_Opacity295 );
				#else
				half staticSwitch738 = Base_Opacity295;
				#endif
				half Output_Opacity739 = staticSwitch738;
...
ASEEND*/
//CHKSM=CB60652B2668640375F522DFC1B688729756AE9F