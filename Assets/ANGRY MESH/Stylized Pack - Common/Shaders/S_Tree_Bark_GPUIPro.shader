...
Shader "GPUInstancerPro/ANGRYMESH/Stylized Pack/Tree Bark"
{
	Properties
	{
...
#pragma multi_compile_instancing
						 ...
						 ) : SV_Target
			{
				...
				half2 texCoord563 = input.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				half2 texCoord565 = input.ase_texcoord8.zw * float2( 1,1 ) + float2( 0,0 );
				...
				half2 texCoord594 = input.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				...
				half2 texCoord580 = input.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				half4 tex2DNode577 = tex2D( _BaseSMAE, texCoord580 );
				half2 texCoord581 = input.ase_texcoord8.zw * float2( 1,1 ) + float2( 0,0 );
				...
				half2 texCoord571 = input.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				...
				half2 texCoord572 = input.ase_texcoord8.zw * float2( 1,1 ) + float2( 0,0 );
				...
				half2 texCoord668 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				...
				half2 texCoord705 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
...
ASEEND*/
//CHKSM=B32E4327D98A9B02BF3614AA2E397DEA37076E03